from flask import Flask, request, jsonify # TASK 4 Flask for REST API
...
#Initailize a blank global variable to store shared AES key instead of a hardcoded secret key
shared_key = None
...
def get_cert():
    ...
    return jsonify({
        ...
        "pubkey": base64.b64encode(pub_key).decode()
    })
